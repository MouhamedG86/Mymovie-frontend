...
function Home() {
  ...
  useEffect(() => {
    fetch('https://mymoviz-backend-beta-three.vercel.app/movies')
  ...
  const movies = moviesData.map((data, i) => {
    ...
    return <Movie key={i} updateLikedMovies={updateLikedMovies} isLiked={isLiked} title={data.title} overview={data.overview.substring(0,250) + '...'} poster={"https://image.tmdb.org/t/p/w500/"+data.poster_path} vote_average={data.vote_average} voteCount={data.vote_count} />;
  });
